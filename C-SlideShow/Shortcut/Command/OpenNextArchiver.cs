...
{
    public class OpenNextArchiver : ICommand
    {
        ...
        public OpenNextArchiver()
        {
            ID    = CommandID.OpenNextArchiver;
            Scene = Scene.All;
        }
        ...
        public void Execute()
        {
            ...
            {
                message = "次のフォルダ(書庫)： " + Path.GetFileName( nextPath );
            }
